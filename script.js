document.addEventListener('DOMContentLoaded', () => {
    ...
    const advanceOnboarding = (userResponse) => {
        switch (onboardingState) {
            ...
            case 'ASKING_Height':
                ...
                onboardingState = 'ASKING_MEDICAL';
            ...
            case 'ASKING_GOAL':
                ...
                onboardingState = 'CONFIRMING_DATA'; 
    ...
    openChatBtn.addEventListener('click', () => {
        ...
        chatView.classList.add('active'); // Langsung Tampilkan Chat
    ...
    // Event Listeners untuk input chat
    ...
    chatBox.addEventListener('click', (e) => {
        if (e.target.classList.contains('chat-option-btn')) {
            ...
            // Masih ada sedikit jeda di sini agar user sempat melihat jawaban bot sebelum pertanyaan berikutnya
